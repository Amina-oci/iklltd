...
document.write('<scr'+'ipt type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key= AIzaSyAN2mqujz24NMGjaAVasia4atSGC6rofNU&sensor=false" ></scr'+'ipt>');
...
;(function($, window, undefined) {
	...
	$.fn.mapit = function(options) {
		...
		var defaults = {
			...
			scrollwheel: false,
			marker: {
				latitude: 	23.075297 /*37.970996*/,
				longitude: 	70.133673 /*23.730542*/,
				icon: 			'images/marker_red.png',
				title: 			'The Hotel',
				open: 			false,
				center: 		true
			},
			address: '<h2>Address</h2>IFFCO Sadan,<br />C-1,District Centre, Saket,<br />New Delhi-17, INDIA</p>',
			styles: 'GRAYSCALE',
			locations: [
				[70.133673, 23.075297, 'images/marker_blue.png', 'Cinema Aello 5+1', 'Panagi Tsaldari 140, Athina, Greece', false, '1'],
				[70.133673, 23.075297, 'images/marker_blue.png', 'Cinema Ilion', 'Τροίας 34, Αθήνα, Greece', false, '1'],
				[70.133673, 23.075297, 'images/marker_blue.png', 'Cinema Calipso', 'Megalou Alexandrou ke Kalipsous, Kallithea, Greece', false, '1'],
				[70.133673, 23.075297, 'images/marker_green.png', 'Technopolis', 'Πειραιώς 100, Αθήνα, Greece', false, '2'],
				[70.133673, 23.075297, 'images/marker_green.png', 'Zappeion', 'Greece', false, '2'],
				[70.133673, 23.075297, 'images/marker_green.png', 'Εθνική Πινακοθήκη Μουσείο Αλεξάνδρου Σούτζου', 'Μιχαλακοπούλου 1, Αθήνα, Greece', false, '2'],
				[70.133673, 23.075297, 'images/marker_green.png', 'Benaki Museum', 'Koumpari 1, Athens, Greece', false, '2']
			],
			origins: [
				['70.133673', '23.075297'],
				['70.133673', '23.075297']
